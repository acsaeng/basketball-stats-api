...
namespace BasketballStatsApi.Infrastructure.Migrations
{
    ...
    [Migration("20250409211440_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasketballStatsApi.Core.Entities.Game", b =>
                {
            ...
            modelBuilder.Entity("BasketballStatsApi.Core.Entities.PlayerGame", b =>
                {
                    b.Property<int>("PlayerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BasketballStatsApi.Core.Entities.Game", b =>
                {
                    b.HasOne("BasketballStatsApi.Core.Entities.Team", "AwayTeam")
                        .WithMany("AwayGames")
                        .HasForeignKey("AwayTeamId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BasketballStatsApi.Core.Entities.Team", "HomeTeam")
                        .WithMany("HomeGames")
            ...
            modelBuilder.Entity("BasketballStatsApi.Core.Entities.PlayerGame", b =>
                {
                    b.HasOne("BasketballStatsApi.Core.Entities.Game", "Game")
                        .WithMany("PlayerStats")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BasketballStatsApi.Core.Entities.Player", "Player")
                        .WithMany("GameStats")
